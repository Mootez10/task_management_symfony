 ...
 */
final class Version20241031141238 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD manager_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE task ADD employee_id INT NOT NULL, ADD project_id INT NOT NULL');
